      ...
      <div className="container">
        ...
        <div className={scss.registerForm}>
          <div className={scss.form_container}>
            <p className={scss.title}>Welcome back</p>

            <form className={scss.form}>
              <input type="text" className={scss.input} placeholder="Name" />
              <input
                type="text"
              ...
              />
              <p className={scss.page_link}>
                <span className={scss.page_link_label}>Forgot Password?</span>
              </p>
              <button
                type="submit"
                onClick={(e) => {
            ...
            <div className={scss.buttons_container}>
              <div
                ...
                className={scss.google_login_button}
              >
                <svg
                  stroke="currentColor"
                  fill="currentColor"
